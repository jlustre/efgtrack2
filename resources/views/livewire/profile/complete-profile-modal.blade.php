    ...
    <div class="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-xl shadow-lg">
        <div class="bg-green-100 border border-green-400 text-green-700 px-6 py-4 rounded-lg relative flex items-center justify-between"
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <strong class="font-bold">Profile Saved!</strong>
                    <span class="block sm:inline ml-2">Your profile is {{ $percent }}% complete.</span>
                </div>
            </div>
            <div class="flex gap-3">
                <button type="button" wire:click="hideSuccessMessage"
                    class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition">Close</button>
                <button type="button" wire:click="continueFillingUp"
                    class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Continue Filling
                    Up</button>
            </div>
            <button type="button" wire:click="hideSuccessMessage"
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select wire:model="form.state_id"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Best Contact Times</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Licensed <span
                                class="text-gray-500 text-xs">(Life, health or both)</span></label>
                ...
                <div class="pt-6">
                    <button type="submit"
                        class="w-full py-2 px-4 bg-blue-600 text-white rounded hover:bg-blue-700">Save</button>
                </div>
            </form>
        </div>
    </div>
