                                    ...
                                    <div class="flex items-center space-x-2">
                                        <div class="w-32 bg-gray-200 rounded-full h-2">
                                            <div class="bg-primary-600 h-2 rounded-full"
                                                style="width: {{ Auth::user()->isProfileComplete() ? 100 : 60 }}%">
                                            </div>
                                        </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6 border-b border-gray-200">
                                ...
                                <p class="mt-1 text-sm text-gray-600">Update your personal details and contact
                                    information.</p>
                            </div>
                            <div class="p-6">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="text-sm font-medium text-gray-900">{{
                                            \App\Models\User::where('sponsor_id', Auth::id())->count() }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                            ...
                            <div class="p-6">
                                ...
                                <div class="mb-4 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <img class="h-8 w-8 rounded-full" src="{{ Auth::user()->sponsor->avatar_url }}"
                                            alt="">
                                        <div>
                                            <div class="text-sm font-medium">{{ Auth::user()->sponsor->full_name }}
                                            </div>
                                            <div class="text-xs text-gray-500">{{ '@'.Auth::user()->sponsor->username }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="text-xs text-gray-500">+{{ Auth::user()->sponsoredMembers->count() -
                                            3 }} more</div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <button
                                        class="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-md">Export
                                        My Data</button>
                                    <button
                                        class="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-md">Download
