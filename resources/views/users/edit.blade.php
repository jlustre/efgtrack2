    ...
    <div class="flex-1 container mx-auto py-8">
        ...
        <form action="{{ route('users.update', $user) }}" method="POST"
            ...
            <div x-show="tab === 'personal'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    <label for="avatar_path" class="block text-gray-700">Avatar Filename</label>
            ...
            <div x-show="tab === 'business'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-4">
                    <label for="is_licensed" class="block text-gray-700">Licensed</label>
                    <select name="is_licensed" id="is_licensed" class="w-full border px-3 py-2 rounded">
                        <option value="1" @if($user->is_licensed == 1) selected @endif>Yes</option>
                        <option value="0" @if($user->is_licensed == 0) selected @endif>No</option>
                    </select>
                </div>
                <div class="mb-4">
                    <label for="sponsor_id" class="block text-gray-700">Sponsor ID</label>
                ...
                <div class="mb-4">
                    <label for="rank_id" class="block text-gray-700">Rank ID</label>
                    <input type="number" name="rank_id" id="rank_id" value="{{ old('rank_id', $user->rank_id) }}"
                        class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-4">
                    <label for="assigned_mentor_id" class="block text-gray-700">Assigned Mentor ID</label>
                    <input type="number" name="assigned_mentor_id" id="assigned_mentor_id"
                        value="{{ old('assigned_mentor_id', $user->assigned_mentor_id) }}"
                        class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-4">
                    <label for="assigned_manager_id" class="block text-gray-700">Assigned Manager ID</label>
            ...
            <div x-show="tab === 'location'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    <label for="state_province_id" class="block text-gray-700">State/Province</label>
                ...
                <div class="mb-4">
                    <label for="timezone_id" class="block text-gray-700">Timezone</label>
                ...
                <div class="mb-4">
                    <label for="best_contact_times" class="block text-gray-700">Best Contact Times</label>
            ...
            <div x-show="tab === 'other'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    <label for="member_status" class="block text-gray-700">Member Status</label>
                ...
                <div class="mb-4">
                    <label for="theme_settings" class="block text-gray-700">Last Login IP</label>
                ...
                <div class="mb-4">
                    <label for="theme_settings" class="block text-gray-700">Last Login At</label>
                    <input type="text" name="last_login_at" id="last_login_at"
                        value="{{ old('last_login_at', $user->last_login_at) }}"
                        class="w-full border px-3 py-2 rounded bg-gray-100" readonly>
                </div>
                <div class="mb-4">
                    <label for="theme_settings" class="block text-gray-700">Theme Settings (JSON)</label>
            ...
            <button type="submit" class="bg-yellow-500 text-white px-4 py-2 rounded mt-6">Update User</button>
